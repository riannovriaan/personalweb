                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="col_left" class="form-control" placeholder="Link for Left Column">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Link Untuk Kolom Kanan:</strong>
                            <input class="form-control" type="text" name="col_right" placeholder="Link for Right Column">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Nama Project</strong>
                            <textarea class="form-control" style="height:150px" name="projectname" placeholder="Project Name ex: Project 1 (kiri) & Project 2 (kanan)"></textarea>
                        </div>
                    </div>
